            ...
            <div className=" row p-2 ">
                ...
                <ul className="list-unstyled col-7 ">
                    ...
                    <li>
                        ...
                        <small>mike.ana@example.com</small>
                    </li>
                </ul>

                <div className="contact-accions col-2    ">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-pencil-fill me-5" viewBox="0 0 16 16">
